...
CREATE TABLE "new_days_habits" (
    ...
    CONSTRAINT "days_habits_day_id_fkey" FOREIGN KEY ("day_id") REFERENCES "day" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "new_habits_week_days" (
    ...
    CONSTRAINT "habits_week_days_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "habits" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
